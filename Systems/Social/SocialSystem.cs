...
namespace Core.Systems
{
    ...
    /// </summary>
    public class SocialSystem : CoreSystem
    {
        [SerializeField]
        ...
        public IObservable<List<IScore>> LoadScores()
        {
            return Observable.Create<List<IScore>>(
                observer =>
                {
                    ...
                    UnityEngine.Social.LoadScores(_leaderboardID, OnLoadedAchievements);
                    return Disposable.Empty;
                });
        }
        ...
        public IObservable<bool> ReportScore(long score)
        {
            return Observable.Create<bool>(
                observer =>
                {
                    ...
                    UnityEngine.Social.ReportScore(score, _leaderboardID, OnScoreReported);
                    return Disposable.Empty;
                });
        }
    }
