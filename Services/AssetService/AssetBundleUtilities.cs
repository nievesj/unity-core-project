...
namespace Core.Assets
{
	...
	{
		/// <summary>
		/// Returns string "android", "webgl", or "ios", depending on the running client. 
		/// Useful for downloading the correct asset bundle target.
		/// If running in the Editor, returns the same string based on the build target.
		/// Throws an exception if detected running on another platform.
		/// </summary>
